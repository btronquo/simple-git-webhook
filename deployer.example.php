...
#
#   WARNING BEFORE USE  :  UPDATE RENAME deployer.example.php TO deployer.php
#                          UPDATE AND RENAME .htaccess.example TO .htaccess
#
...
#                       13/02/2020 - Add deployer example
#                       13/02/2020 - Add httaccess example
...
$key = getenv('REDIRECT_WEBHOOK_KEY');
 ...
 * you can change the names of the folders as you need
 */
